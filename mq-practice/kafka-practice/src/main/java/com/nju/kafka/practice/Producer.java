...
public class Producer {
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        for (int i = 1; i <= 2; i++) {
            ...
            // 指定分区 , 0
            ProducerRecord<String, String> producerRecord = new ProducerRecord<String, String>(SysConfigUtil.kafkaTopicProducerName()
        ...
        private static Properties makeProducerProperties () {
            ...
            //指定连接的 kafka集群
            props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, SysConfigUtil.kafkaUrls());
