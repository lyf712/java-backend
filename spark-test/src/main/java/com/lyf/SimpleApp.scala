...
object SimpleApp{
  def main(args: Array[String]): Unit ={
    val dataFile = "E:\\JavaProjects\\LearnProjects\\java-backend\\java-crawler\\simple-demo\\src\\main\\resources\\githubdata\\repo_core_info_0_46.csv";
   // val logFile = "E:\\JavaProjects\\CourseProjects\\cloud-compute-lab\\cloud-compute-crawler\\src\\main\\resources\\files\\test\\repo_core_info_0_46.csv";
    ...
    println("Lines with JavaScript: %s,Lines with Ruby: %s".format(numAs,numBs))
    // Lines with a: 1,Lines with b: 1 Lines with a: 4,Lines with b: 2
  }
}